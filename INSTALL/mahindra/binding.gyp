  ...
  [
    {
      ...
      'conditions': [
        ...
        [ 'OS=="freebsd" or OS=="openbsd" or OS=="mac" or OS=="solaris" or OS=="linux"', {
          'include_dirs': ['/usr/local/oecore-1686/sysroots/i585-oesdk-linux/usr/include'],
          'libraries': ['-L/usr/local/oecore-1686/sysroots/i585-oesdk-linux/usr/lib', '-L/usr/local/oecore-1686/sysroots/i585-oesdk-linux/lib', '-lssl', '-lcrypto'],
        }],
      ],
    },
    {
