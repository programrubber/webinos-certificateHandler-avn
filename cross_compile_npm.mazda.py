...
PATH_CROSS_COMPILER = "/opt/mazda/toolchain"
...
os.environ['AR'] = "arm-oe-linux-gnueabi-ar"
print "AR=" + os.environ['AR']
os.environ['CC'] = "arm-oe-linux-gnueabi-gcc  --sysroot=/opt/mazda/sysroot"
print "CC=" + os.environ['CC']
os.environ['CXX'] = "arm-oe-linux-gnueabi-g++  --sysroot=/opt/mazda/sysroot "
print "CXX=" + os.environ['CXX']
os.environ['LD'] = "arm-oe-linux-gnueabi-g++ --sysroot=/opt/mazda/sysroot "
