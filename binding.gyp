  ...
  [
    {
      ...
      'conditions': [
        ...
        [ 'OS=="freebsd" or OS=="openbsd" or OS=="mac" or OS=="solaris" or OS=="linux"', {
          ...
          'libraries': ['-L/home/obigo/work/ces2015/BoundaryDevice/Sysroot/ARMEL/sysroot_armel/usr/lib', '-L/home/obigo/work/ces2015/BoundaryDevice/Sysroot/ARMEL/sysroot_armel/lib', '-lssl', '-lcrypto'],
        }],
      ],  
    },
    {
